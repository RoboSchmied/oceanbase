...
#define OB_ERR_GIS_DATA_WRONG_ENDIANNESS__USER_ERROR_MSG "Geometry byte string must be little endian."
...
#define OB_ERR_GIS_DATA_WRONG_ENDIANNESS__ORA_USER_ERROR_MSG "ORA-00600: Geometry byte string must be little endian."
